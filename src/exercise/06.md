...
In this lesson I learned how to leverage forms, input fields and submissions using react.
There are multiple ways to read and write from both of these and while React.useRef mechanism
feels great, it does not feel like the right solution to every problem, in particular if I am
also managing the referenced object current value for multiple purposes. However, in later
lessons Mr. Kent will teach us more about the usefull ness of React.useRef.

Furthermore, I learned how to programmatically display error messages or control the value
inputted by the user using the `onChange` event handler. It was nice.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=06%3A%20Forms&em=francisco.teixeira.de.barros%40outlook.com).
