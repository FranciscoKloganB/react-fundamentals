...
What we usually refer to as being the React library or, as some would call it, framework, is actually composed of more than
one JavaScript module. On the one hand we have React, which is responsible for creating page elements, similar to the
document.createElement; On the other hand, we have ReactDOM and ReactNative, which are responsible from printing out
those elements to the screen, respectively on Web and Mobile platforms.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=francisco.teixeira.de.barros%40outlook.com).
