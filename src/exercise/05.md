...
In this lesson I learned how to apply inline-styles and css-style classes via JSX.
I already knew about the usefullness of destructuring props, but the practise I had made me fail several times with syntax errors, mostly because I forgot curly braces. I also had suspicions that className and style props would clash with default values and that they would need to be merged somehow and I was correct.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=francisco.teixeira.de.barros%40outlook.com).
